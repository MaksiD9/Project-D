...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "toggleBtn",
    value: function toggleBtn(boolean) {
    ...
    key: "checkInputsEmptyWarning",
    value: function checkInputsEmptyWarning() {
      var _this = this;
      ...
      this.inputs.forEach(function (input) {
        input.addEventListener('blur', function () {
          if (input.value.trim() === '') {
            ...
            _this.toggleBtn(true);
          } else {
            input.placeholder = '';
            input.style.border = '';

            _this.toggleBtn(false);
          }
        });
      });
    }
    ...
    value: function init() {
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (event) {
          event.preventDefault(); // блок для вывода сообщений
          ...
          var _this2$messages = _this2.messages,
              loading = _this2$messages.loading,
              success = _this2$messages.success,
              failure = _this2$messages.failure;
          setTimeout(function () {
            statusMessage.textContent = loading;
          }, 500);
          var formData = new FormData(item);

          _this2.postData(_this2.path, formData).then(function (response) {
...
function (_Slider) {
  ...
  function MainSlider(btns) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns)); // this.prevModule = document.querySelectorAll('.prevmodule');
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      if (this.container) {
        ...
        this.bindTriggers(); // this.toggleButton(this.prevmodule, -1);
...
var Slider = function Slider() {
  ...
  this.next = document.querySelector(next); // this.nextModule = document.querySelectorAll(nextmodule); //
